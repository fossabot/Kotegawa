...
module.exports = {
  ...
  aliases: ["rinfo", "role"], //the command aliases for helpcmd [OPTIONAL]
  ...
  run: async (client, message, args, plusArgs, cmdUser, text, prefix) => {
    try {   
      ...
      if(!role || role == null || role.id == null || !role.id) message.reply("<:no:833101993668771842> Could not find the ROLE")
        ...
        embeduserinfo.setAuthor("Information about:   " + role.name, message.guild.iconURL({ dynamic: true }), `${message.guild.iconURL({format: "png"})}`)
