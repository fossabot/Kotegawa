    ...
    run: async (client, message, args, plusArgs, cmdUser, text, prefix) => {
      try{
        if (args[0]) {
          ...
          const embed = new MessageEmbed()
              .setColor(ee.color)
              .setThumbnail('https://raw.githubusercontent.com/Eilaluth/Eilaluth/main/img/kotegawa.png')
              .setTitle("HELP MENU")
              .setFooter(ee.footertext, ee.footericon)
              .setImage('https://raw.githubusercontent.com/Eilaluth/Kotegawa/main/img/anotheryui.gif')
            .setDescription(`To see command descriptions and information,\r\n type: ${prefix}help [command name]`, client.user.displayAvatarURL());
