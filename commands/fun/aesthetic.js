...
module.exports = {
    name: "aesthetic", //the command name for execution & for helpcmd [OPTIONAL]
    category: "fun", //the command category for helpcmd [OPTIONAL]
    aliases: ["estetik", "alay"], //the command aliases for helpcmd [OPTIONAL]
    cooldown: 5, //the command cooldown for execution & for helpcmd [OPTIONAL]
    usage: "aesthetic [args]", //the command usage for helpcmd [OPTIONAL]
    description: "Ｃｏｎｖｅｒｔ　ｔｅｘｔ　ｔｏ　ａｅｓｔｈｅｔｉｃ　ｓｔｙｌｅ．", //the command description for helpcmd [OPTIONAL]
    ...
    run: async (client, message, args, plusArgs, cmdUser, text, prefix) => {
        ...
        console.log('=======> AESTHETIC RESULT');
        console.log(aesthetics(args.join(' ')));
