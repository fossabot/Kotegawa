...
module.exports = {
  ...
  run: async (client, message, args, plusArgs, cmdUser, text, prefix) => {
    try {
      ...
      //include destroy
      if (args.join(` `).includes(`destroy`)) return console.log(`ERROR: Using client destroy ;)`.red);
      //Desttroy client
      if (string.includes(client.destroy)) return console.log(`ERROR: Using client destroy ;)`.red);
      //define queueembed
